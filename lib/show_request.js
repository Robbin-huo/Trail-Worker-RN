    ...
    return(
      <View style={styles.content}>
        ...
        <Text style={{fontSize: 20}}>
            <Text>Feature Description: {details ? details.feature_description + "\n" : "\n"}</Text>
            <Text>Location Description: {details ? details.location_description + "\n" : "\n"}</Text>
            <Text>Current Vote Count</Text>
        </Text>
        <TouchableHighlight>
          <Text style={styles.button}>Upvote</Text>
        </TouchableHighlight>
        <TouchableHighlight>
          <Text style={styles.button}>Downvote</Text>
        </TouchableHighlight>
      </View>
    );
  }
